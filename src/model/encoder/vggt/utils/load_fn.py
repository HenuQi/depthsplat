...
# 加载并预处理图像
# 输入：
#   image_path_list [B]，所有图像（B张）路径的列表
#   img_load_resolution，加载图像时的分辨率1024
# 输出：
#   images [B, 3, H, W]，
#   original_coords [B, 6]，前两维是左上角坐标，中间两维是原图右下角坐标，后两维是图像的宽高。
#       其作用是记录当前 1024×1024 图像 → 原始图像坐标 的映射关系
